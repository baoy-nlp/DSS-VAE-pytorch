...
class DisentangleVAE(BaseVAE):
    ...
    def __init__(self, args, vocab, src_embed=None, tgt_embed=None):
        super(DisentangleVAE, self).__init__(args, vocab, name="Fixed Disentangle VAE")
    ...
    def get_gpu(self):
        model_list = [self.encoder, self.bridger, self.decoder, self.syn_mean, self.syn_logv, self.syn_to_h,
