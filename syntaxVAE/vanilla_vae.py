...
class VanillaVAE(BaseVAE):
    ...
    def forward(self, examples):
        ...
        tgt_var = to_input_variable(sent_words, self.vocab.src, training=False, cuda=self.args.cuda, append_boundary_sym=True, batch_first=True)
    ...
    def get_loss(self, examples, step):
        ...
        kl_loss, kl_weight = self._kl_loss(explore['mean'], explore['logv'], step)
