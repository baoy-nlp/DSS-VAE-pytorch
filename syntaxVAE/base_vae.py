...
from utils.nn_utils import kl_anneal_function
...
class BaseVAE(nn.Module):
    ...
    def generating(self, sample_num, batch_size=50):
        """
        sample a latent variable, then generating.
        :param sample_num:
        :param batch_size:
        :return:
        """
    ...
    def encode_to_hidden(self, examples, need_sort=False):
        ...
        if not need_sort:
            ...
            src_var = to_input_variable(sent_words, self.vocab.src, training=False, cuda=self.args.cuda, batch_first=True)
